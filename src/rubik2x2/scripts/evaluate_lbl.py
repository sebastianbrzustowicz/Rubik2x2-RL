...
for i in range(1, trials + 1):
    ...
    scramble_moves = np.random.choice(
        list(apply_moves.__globals__["MOVE_MAP"].keys()), size=scramble_len
    )
    ...
    side_ok = (
        cube.state[2][2] == 2
        and cube.state[2][3] == 2
        and cube.state[3][2] == 3
        and cube.state[3][3] == 3
        and cube.state[4][2] == 4
        and cube.state[4][3] == 4
        and cube.state[5][2] == 5
        and cube.state[5][3] == 5
    )
